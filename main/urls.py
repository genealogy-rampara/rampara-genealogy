...
urlpatterns = [
    ...
    # path('person/person_detail_previous_person_id/<int:person_id>/', views.person_detail_previous_person_id, name='person_detail_previous_person_id'),
    # path('person/person_detail_next_person_id/<int:person_id>/', views.person_detail_next_person_id, name='person_detail_next_person_id'),
